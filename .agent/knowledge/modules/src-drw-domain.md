...
Owns the in-memory domain data abstraction for the core manual queue: counterparties, disputes, exceptions, report sources, timeline rows, audit rows, per-tenant dispute references, and SLA breach claims.
