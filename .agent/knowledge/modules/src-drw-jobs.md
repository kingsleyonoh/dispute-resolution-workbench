...
- Domain SLA and resolution job tests verify one breach per dispute/due-at pair, audit/timeline side effects, ignored terminal disputes, and Workflow Engine terminal status application.
