# Dispute Resolution Workbench — Coding Standards: Live & Integration Testing
...
- Your database (Datomic Pro dev-local, PostgreSQL 16, Redis 7, optional NATS) — validates schema, column names, constraints, query behavior
