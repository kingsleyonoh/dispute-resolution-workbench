...
| `CODING_STANDARDS.md` | Workflow pipeline, approval gates, domain-rule routing, git convention, file size limits |
...
| `CODING_STANDARDS_RUNTIME.md` | Code organization, logging, error responses, server-side performance, structure rules |
| `CODING_STANDARDS_TESTING_QUALITY.md` | Test quality checklist, edge case coverage, modularity, business-context testing |
| `CODING_STANDARDS_AI_DISCIPLINE.md` | Core AI discipline, full-read rule, shared foundation rule, anti-duplication |
