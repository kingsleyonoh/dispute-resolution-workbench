# Dispute Resolution Workbench — Coding Standards: Testing (Core TDD)
...
> Test quality checklist, edge cases, modularity, and business-context testing live in CODING_STANDARDS_TESTING_QUALITY.md.
